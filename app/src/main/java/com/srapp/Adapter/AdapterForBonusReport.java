...
public class AdapterForBonusReport extends BaseAdapter {
    ...
    public AdapterForBonusReport(Activity context, ArrayList<HashMap<String, String>> arraylistContent) {
...
//		return position;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.product_wise_bonus_report, null);
        ...
        sale_quntity.setText(mapContent.get("bonusqty"));
