    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLastMemo.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(PrintAllMemosActivity.this, DeliveryReport.class));
                finish();
        ...
        ActivityCompat.requestPermissions(PrintAllMemosActivity.this,
                new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                1);
        pd = new ProgressDialog(PrintAllMemosActivity.this);
            ...
            mEnableBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        Toast.makeText(PrintAllMemosActivity.this, "Please enable bluetooth!", Toast.LENGTH_LONG).show();
                    }
...
*/
    ...
    private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            i = 0;
            String action = intent.getAction();
            if (PrintAllMemosActivity.ACTION_USB_PERMISSION.equals(action)) {
                synchronized (this) {
    ...
    public void printUsb() {
        ...
        threadPool.addSerialTask(new Runnable() {
            @Override
            public void run() {
                portManager=new UsbPort(PrintAllMemosActivity.this, mUsbDevice);//实例化对象
