...
//      return a;
  ...
  public static byte[] FramePack(byte typeFrame, byte[] srcBuff, int srcOffset, int srcLen)
  {
	  ...
	  Log.e("typeFrame", ""+typeFrame);
	  Log.e("srcBuff", new String(srcBuff));
	  Log.e("srcOffset", ""+srcOffset);
	  Log.e("srcLen", ""+srcLen);
    ...
    if (typeFrame == FRAME_PHONE 
      ...
      Log.e("countSpecialBytes", ""+countSpecialBytes);
...
//      offset++;
      ...
      buffer[offset] = B_EOF;
      offset++;
      Log.e("Buffer:", new String(buffer));
      return buffer;
    }
...
//    }
  ...
  //  if (fontSet != FONT_DEFAULT)
   ...
   fontlinespace = new byte[]{B_ESC,(byte)0x33,linespace};
    ...
    Log.e("formate value = ", StringUtil.toHexString(formate));
    Log.e("formate buffer:", ""+concatByteArray(formate, buffer));
    Log.e("FORMAT STRING:", new String(formate));
    Log.e("FORMAT BUFFER", new String(buffer));
