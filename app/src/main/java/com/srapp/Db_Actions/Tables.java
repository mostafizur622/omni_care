...
import static com.srapp.helpers.SpecialPolicyHelper.OUTLET_IGNORE;
import static com.srapp.helpers.SpecialPolicyHelper.TABLE_NAME_INGONORE_OUTLET_FOR_POLICY;
...
/*
    *//*..................................Territories Table......................................... *//*
    ...
    public static final String GPS_TRACKER_STATUS = "status";
    public static final String GPS_TRACKER_ADDRESS = "address";
    public static final String GPS_TRACKER_NETWORK_TYPE = "type";
    ...
    public static final String CREATE_GPS_TRACKER_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_GPS_TRACKER +
            ...
            GPS_TRACKER_STATUS + "  VARCHAR,   " +
            GPS_TRACKER_ADDRESS + "  VARCHAR,   " +
    ...
    public static final String TABLE_NAME_GPS_TRACKING_GAPE_TIME = "gps_tracking_gape_time";

    public static final String GPS_TRACKING_TIME_GAPE_table_id = "_id";
    public static final String GPS_TRACKING_INSERT_TIME = "insert_time";
    public static final String GPS_TRACKING_GAPE_TIME = "gape_time";
    public static final String GPS_TRACKING_GAPE_LAST_TIME = "last_time";
    public static final String GPS_TRACKING_GAPE_IS_PUSH_TIME = "is_pushed";
    public static final String GPS_TRACKING_TIME_GAPE_created_at = "created_at";
    public static final String GPS_TRACKING_TIME_GAPE_updated_at = "updated_at";

    public static final String GPS_TRACKING_GAPE_TIME_[] = {TABLE_NAME_GPS_TRACKING_GAPE_TIME,GPS_TRACKING_TIME_GAPE_table_id, GPS_TRACKING_INSERT_TIME, GPS_TRACKING_GAPE_TIME,GPS_TRACKING_GAPE_LAST_TIME,GPS_TRACKING_GAPE_IS_PUSH_TIME,
            GPS_TRACKING_TIME_GAPE_created_at, GPS_TRACKING_TIME_GAPE_updated_at};


    public static final String CREATE_GPS_TRACKING_GAPE_TIME_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_GPS_TRACKING_GAPE_TIME +
            " ( " +
            GPS_TRACKING_TIME_GAPE_table_id + " INTEGER PRIMARY KEY,   " +
            GPS_TRACKING_INSERT_TIME + "  TIME,   " +
            GPS_TRACKING_GAPE_TIME + "  TIME,   " +
            GPS_TRACKING_GAPE_LAST_TIME + "  TIME,   " +
            GPS_TRACKING_GAPE_IS_PUSH_TIME + "  VARCHAR,   " +
            GPS_TRACKING_TIME_GAPE_created_at + "  INTEGER,   " +
            GPS_TRACKING_TIME_GAPE_updated_at + "  DATETIME );";
...
*/
    ...
    final  public static  String ORDER_START_TIME = "order_create_start_time";

    final public static  String ORDER_END_TIME = "order_create_end_time";
    ...
    public static final String ORDER[] = {TABLE_NAME_ORDER,ORDER_table_id, ORDER_order_number, ORDER_order_date, ORDER_order_date_time, ORDER_sales_to, ORDER_STATUS,ORDER_outlet_id, ORDER_market_id,  ORDER_gross_value, ORDER_cash_received, ORDER_credit_amount, ORDER_is_active, ORDER_latitude,
            ORDER_longitude, ORDER_from_app,ORDER_sales_person_id,SR_ID,ORDER_discount_Type,ORDER_START_TIME,ORDER_END_TIME,ORDER_is_out_of_plan,ORDER_plan_id, ORDER_TOTAL_VAT,ORDER_discount_amount, ORDER_discount_Percentage,ORDER_for_order_delete, ORDER_editable, ORDER_is_pushed, ORDER_is_distributor,ORDER_total_discount,
    ...
    /*..................................Offer Type......................................... */
    public static final String TABLE_Name_OFFER_TYPE = "offer_type";

    public static final String OFFER_TYPE_id = "_id";
    public static final String OFFER_TYPE_offer_ID = "offer_id";
    public static final String OFFER_TYPE_Offer_Name = "name";
    public static final String OFFER_TYPE_status = "status";
    public static final String OFFER_TYPE_start_date = "start_date";
    public static final String OFFER_TYPE_end_date = "end_date";
    public static final String OFFER_TYPE__UPDATED_AT = "updated_at";
    ...
    public static final String CREATE_OFFER_TABLE = "CREATE TABLE IF NOT EXISTS "+TABLE_Name_OFFER_TYPE+" ( "
            + OFFER_TYPE_id + " INTEGER PRIMARY KEY," +
            OFFER_TYPE_offer_ID + " INTEGER," +
            OFFER_TYPE_Offer_Name + " VARCHAR," +
            OFFER_TYPE_status + " INTEGER," +
            OFFER_TYPE_start_date + " DATE," +
            OFFER_TYPE_end_date + " DATE," +
            OFFER_TYPE__UPDATED_AT + " DATETIME DEFAULT (DATETIME(CURRENT_TIMESTAMP, 'LOCALTIME'))" +
            ")";
    /*..................................NCP_CHALLAN_DETAILS......................................... */
...
//...............................OUTLET TABLE......................................................
    ...
    public static final String TABLE_NAME_TEMP_OUTLETS = "temp_outlets";



    public static final String TEMP_OUTLETS[] = {TABLE_NAME_OUTLETS,OUTLETS_P_id, OUTLETS_ID,OUTLETS_OUTLET_NAME,
             OUTLETS_THANA_ID,
            OUTLETS_MARKET_ID, OUTLETS_CATAGORY_ID, OUTLETS_NGO_INST_ID,
            OUTLETS_PROJECT_ID,  OUTLETS_INCHARGE_NAME,
            OUTLETS_OWNER_NAME, OUTLETS_MOBILE,OUTLETS_Image, OUTLETS_ADDRESS,
    ...
    public static final String CREATE_TEMP_OUTLETS_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME_TEMP_OUTLETS + "("
            + OUTLETS_P_id + " INTEGER PRIMARY KEY," +
            OUTLETS_ID + " VARCHAR," +
            OUTLETS_THANA_ID + " INTEGER," +
            OUTLETS_MARKET_ID + " VARCHAR," +
    ...
    //...............................OUTLET Permission TABLE......................................................

    public static final String TABLE_OUTLET_PERMISSION = "outlet_create_permission_list";

    public static final String OUTLET_PERMISSION_ID = "_id";
    public static final String OUTLET_PERMISSION_START_TIME = "start_time";
    public static final String OUTLET_PERMISSION_END_TIME = "end_time";
    public static final String OUTLET_PERMISSION_NO_OF_OUTLET = "no_of_outlet";
    public static final String OUTLET_PERMISSION_UPDATED_AT = "updated_at";
    public static final String OUTLET_PERMISSION_CREATED_AT = "created_at";

    public static final String OUTLET_PERMISSIONS[] = {TABLE_OUTLET_PERMISSION,OUTLET_PERMISSION_ID,OUTLET_PERMISSION_START_TIME,OUTLET_PERMISSION_END_TIME,OUTLET_PERMISSION_NO_OF_OUTLET,OUTLET_PERMISSION_UPDATED_AT,OUTLET_PERMISSION_CREATED_AT};

    public static final String CREATED_OUTLET_PERMISSION_TABLE = "CREATE TABLE IF NOT EXISTS " + TABLE_OUTLET_PERMISSION + "("
            + "_id" + " INTEGER PRIMARY KEY," +
            OUTLET_PERMISSION_START_TIME + " VARCHAR," +
            OUTLET_PERMISSION_END_TIME + " INTEGER," +
            OUTLET_PERMISSION_NO_OF_OUTLET + " INTEGER," +
            OUTLET_PERMISSION_UPDATED_AT + " DATETIME DEFAULT (DATETIME(CURRENT_TIMESTAMP, 'LOCALTIME'))," +
            OUTLET_PERMISSION_CREATED_AT + " DATETIME DEFAULT (DATETIME(CURRENT_TIMESTAMP, 'LOCALTIME'))" +
            ")";
...
//...............................OUTLET TABLE......................................................
    ...
    public static final String PRODUCT_BOOLEAN_PRODUCT_NAME = "product_name";
    ...
    public static final String PRODUCT_BOOLEANS[] = {TABLE_NAME_PRODUCT_BOOLEAN,PRODUCT_BOOLEAN_id,
            ...
            PRODUCT_BOOLEAN_BOOLEAN,PRODUCT_BOOLEAN_PRODUCT_NAME, PRODUCT_BOOLEAN_PRODUCT_CATAGORY_ID, PRODUCT_BOOLEAN_PRODUCT_TYPE_ID,
    ...
    public static final String PRODUCT_COMBINATION[] = {TABLE_NAME_PRODUCT_COMBINATION,PRODUCT_COMBINATION_P_id,  PRODUCT_COMBINATION_COMBINE_ID, PRODUCT_COMBINATION_PRODUCT_ID,
            PRODUCT_COMBINATION_COMBINE_ID, PRODUCT_COMBINATION_MIN_QUANTITY,PRODUCT_PRICE_ID, PRODUCT_COMBINATION_PRICE,
    ...
    public static final String PRODUCT_QTY_IN_BASE = "qty_in_base";
    ...
    public static final String PPRODCUT[] = {TABLE_NAME_PRODUCT,PRODUCT_P_id,
            PRODUCT_PRODUCT_ID, PRODUCT_PRODUCT_NAME,PRODUCT_PRODUCT_NAME_BN, PRODUCT_CATAGORY_ID, PRODUCT_TYPE_ID,PRODUCT_QTY_IN_BASE, PRODUCT_ORDER,PRODUCT_PARENT_ID,PRODUCT_IS_VIRTUAL, PRODUCT_IS_INJECTABLE,PRODUCT_IMAGE_URL,PRODUCT_DISPLAY_NAME,PRODUCT_SALES_DATA, PRODUCT_UPDATED_AT, PRODUCT_CREATED_AT};
    ...
    public static final String TABLE_FRACTION = "product_fraciton_slab";
    public static final String _FRACTION_ID = "_id";
    public static final String _FRACTION_WEB_ID = "id";
    public static final String _FRACTION_SALES_QTY = "sales_qty";
    public static final String _FRACTION_BONUS_QTY = "bonus_qty";
    public static final String _FRACTION_BASE_QTY = "base_qty";
    public static final String _FRACTION_USE_FOR_SALE = "use_for_sales";
    public static final String _FRACTION_USE_FOR_BONUS = "use_for_bonus";
    public static final String _FRACTION_PRODUCT_ID = "product_id";
    public static final String _FRACTION_UPDATE_AT = "updated_at";

    public static final String FRACTION_FIELD[] = {TABLE_FRACTION,_FRACTION_ID,_FRACTION_WEB_ID,_FRACTION_SALES_QTY,
            _FRACTION_BONUS_QTY, _FRACTION_BASE_QTY,_FRACTION_USE_FOR_SALE,_FRACTION_USE_FOR_BONUS,_FRACTION_PRODUCT_ID,_FRACTION_UPDATE_AT};

    public static final String CREATE_TABLE_FRACTION = "CREATE TABLE IF NOT EXISTS " + TABLE_FRACTION + " ("
            + _FRACTION_ID + " INTEGER PRIMARY KEY, "
            + _FRACTION_WEB_ID + " TEXT, "
            + _FRACTION_SALES_QTY + " DOUBLE, "
            + _FRACTION_BONUS_QTY + " INTEGER, "
            + _FRACTION_BASE_QTY + " INTEGER, "
            + _FRACTION_USE_FOR_SALE + " INTEGER, "
            + _FRACTION_USE_FOR_BONUS + " INTEGER, "
    ...
    public static final String All_TABLE_NAME[] = {TABLE_NAME_DISCOUNT,TABLE_NAME_BANK_BRANCH, TABLE_NAME_BONUS_PARTY, TABLE_NAME_BONUSES, TABLE_NAME_CREDIT_COLLECTION, TABLE_NAME_CURRENT_PROMOTION_PRODUCTS, TABLE_NAME_DEPOSIT_BALANCE
            ...
            TABLE_NAME_PRODUCT_HISTORY, TABLE_NAME_PRODUCT_PRICE, TABLE_NAME_PRODCUT_TYPE,TABLE_NAME_DIST_BONUS_PRODUCT,TABLE_NAME_INGONORE_OUTLET_FOR_POLICY,TABLE_NAME_TEMP_OUTLETS,TABLE_OUTLET_PERMISSION, TABLE_NAME_PRODUCT,TABLE_NAME_ORDER,TABLE_NAME_ORDER_DETAILS ,TABLE_NAME_SALES_WEEK, TABLE_NAME_SO_TARGETS, TABLE_NAME_TERRITORY, TABLE_NAME_THANA, TABLE_NAME_THANA_TERRITORY, TABLE_NAME_UNIT, TABLE_NAME_ROOT, TABLE_NAME_VISIT_PLAN,TABLE_NAME_FISCAL_YEAR,TABLE_FRACTION};
    ...
    public static final String[][] Allfild = {DISCOUNT,BANK_BRANCH, BONUS_PARTY, BONUSES, CREDIT_COLLECTION, CURRENT_PROMOTION_PRODUCTS, DEPOSIT_BALANCE, DEPOSITS, DESIGNATION
            ...
            PPRODCUT_TYPE, PPRODCUT, SALES_WEEK, SO_TARGETS, TERRITORY, THANA, THANA_TERRITORY,TEMP_OUTLETS,OUTLET_PERMISSIONS, OUTLET_IGNORE,UNIT,OFFER_TYPES, VISIT_PLAN, ROOT,DIST_BONUS,FISCAL_YEAR,FRACTION_FIELD};
