...
public class CancelOrder extends Parent implements BasicFunctionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent( CancelOrder.this, Dashboard.class));
                finish();
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( CancelOrder.this, Tools.class));
                finish();
            }
        });
    ...
    public void OnConnetivityError() {
        Toast.makeText(CancelOrder.this,"No Internet Connection", Toast.LENGTH_SHORT).show();
